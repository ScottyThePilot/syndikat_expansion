...
class CfgPatches {
  class ADDON {
    ...
    units[] = {
      ...
      "I_BD_Crew_F",
      "I_BD_Soldier_Elite_base_F",
      "I_BD_Soldier_Elite_Officer_F",
      "I_BD_Soldier_Elite_TeamLeader_F",
      "I_BD_Soldier_Elite_Gunner_F",
      "I_BD_Soldier_Elite_Sniper_F",
      "I_BD_Soldier_Elite_Scout_F",
      "I_BD_Soldier_Elite_Scout_LAT_F"
    };
    weapons[] = {
