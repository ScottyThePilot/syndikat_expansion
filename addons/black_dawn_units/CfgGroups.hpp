class Infantry {
  ...
  class I_BD_BanditFireTeam {
    ...
    class Unit0 {
      side = 2;
      vehicle = "I_BD_Soldier_Bandit_4_F";
      rank = "SERGEANT";
      position[] = { 0, 0, 0 };
    };
    ...
    class Unit1 {
      side = 2;
      vehicle = "I_BD_Soldier_Bandit_3_F";
      rank = "PRIVATE";
      position[] = { 5, -5, 0 };
    };
    ...
    class Unit2 {
      side = 2;
      vehicle = "I_BD_Soldier_Bandit_5_F";
      rank = "CORPORAL";
      position[] = { -5, -5, 0 };
    };
    ...
    class Unit3 {
      side = 2;
      vehicle = "I_BD_Soldier_Bandit_1_F";
      rank = "PRIVATE";
      position[] = { 10, -10, 0 };
    };
  };

  class I_BD_BanditShockTeam {
    ...
    class Unit0 {
      side = 2;
      vehicle = "I_BD_Soldier_Bandit_6_F";
      rank = "SERGEANT";
      position[] = { 0, 0, 0 };
    };
    ...
    class Unit1 {
      side = 2;
      vehicle = "I_BD_Soldier_Bandit_2_F";
      rank = "PRIVATE";
      position[] = { 5, -5, 0 };
    };
    ...
    class Unit2 {
      side = 2;
      vehicle = "I_BD_Soldier_Bandit_7_F";
      rank = "CORPORAL";
      position[] = { -5, -5, 0 };
    };
    ...
    class Unit3 {
      side = 2;
      vehicle = "I_BD_Soldier_Bandit_8_F";
      rank = "PRIVATE";
      position[] = { 10, -10, 0 };
    };
  };

  class I_BD_BanditCombatGroup {
  ...
  class I_BD_ParaFireTeam {
    ...
    class Unit1 {
      side = 2;
      vehicle = "I_BD_Soldier_Para_Autorifleman_F";
      rank = "PRIVATE";
      position[] = { 5, -5, 0 };
    };
    ...
    class Unit3 {
      side = 2;
      vehicle = "I_BD_Soldier_Para_3_F";
      rank = "PRIVATE";
      position[] = { 10, -10, 0 };
    };
  };

  class I_BD_ParaShockTeam {
  ...
  class I_BD_ParaCombatGroup {
    ...
    class Unit0 {
      side = 2;
      vehicle = "I_BD_Soldier_Para_Commander_F";
      rank = "SERGEANT";
      position[] = { 0, 0, 0 };
    };
  ...
  class I_BD_ParaTeamAA {
    ...
    class Unit1 {
      side = 2;
      vehicle = "I_BD_Soldier_Para_AA_F";
      rank = "CORPORAL";
      position[] = { 5, -5, 0 };
    };
  ...
  class I_BD_ParaTeamAT {
    ...
    class Unit1 {
      side = 2;
      vehicle = "I_BD_Soldier_Para_AT_F";
      rank = "CORPORAL";
      position[] = { 5, -5, 0 };
    };
...
class SpecOps {
  ...
  class I_BD_EliteGroup {
    ...
    class Unit0 {
      side = 2;
      vehicle = "I_BD_Soldier_Elite_TeamLeader_F";
      rank = "SERGEANT";
      position[] = { 0, 0, 0 };
    };
    ...
    class Unit1 {
      side = 2;
      vehicle = "I_BD_Soldier_Elite_Sniper_F";
      rank = "CORPORAL";
      position[] = { 5, -5, 0 };
    };
    ...
    class Unit2 {
      side = 2;
      vehicle = "I_BD_Soldier_Elite_Gunner_F";
      rank = "PRIVATE";
      position[] = { -5, -5, 0 };
    };
    ...
    class Unit3 {
      side = 2;
      vehicle = "I_BD_Soldier_Elite_Scout_LAT_F";
      rank = "PRIVATE";
      position[] = { 10, -10, 0 };
    };
  };

  class I_BD_EliteSentry {
    ...
    class Unit1 {
      side = 2;
      vehicle = "I_BD_Soldier_Elite_Scout_F";
      rank = "PRIVATE";
      position[] = { 5, -5, 0 };
    };
  };
...
class Motorized {
  ...
  class I_BD_MotParaAssaultGroup {
    ...
    class Unit0 {
      side = 2;
      vehicle = "I_BD_Truck_02_transport_F";
      rank = "PRIVATE";
      position[] = { 0, 0, 0 };
    };
  ...
  class I_BD_MotParaReinforcements {
